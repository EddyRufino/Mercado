<div class="form-group row">
    <label for="nombre_empresa" class="col-md-4 col-form-label text-md-right font-weight-normal text-dark text-dark">Nombre Empresa</label>
...
<div class="form-group row">
    <label for="ruc" class="col-md-4 col-form-label text-md-right font-weight-normal text-dark">R.U.C Empresa</label>
...
<div class="form-group row">
    <label for="fecha_inicio" class="col-md-4 col-form-label text-md-right font-weight-normal text-dark">Fecha Inicio</label>
...
<div class="form-group row">
    <label for="monto" class="col-md-4 col-form-label text-md-right font-weight-normal text-dark">Monto Pago</label>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="num_recibo" type="text" class="form-control @error('num_recibo') is-invalid @enderror" name="num_recibo" value="{{ $tazaInicio == $tazaFin ? 'Actualiza Talonario' : $tazaInicio + 1 }}" readonly autocomplete="num_recibo" autofocus>
