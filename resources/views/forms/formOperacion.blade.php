...
<div class="form-group row">
    <label for="num_operacion" class="col-md-4 col-form-label text-md-right font-weight-normal text-dark">N. Operación</label>
...
<div class="form-group row">
    <label for="monto_deposito" class="col-md-4 col-form-label text-md-right font-weight-normal text-dark">Monto Deposito</label>
