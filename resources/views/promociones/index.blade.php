            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="d-flex justify-content-around align-items-center mt-3">
                        <h4 class="text-secondary text-center font-weight-bold mt-1">Promociones</h4>
                        <a class="btn btn-primary btn-sm" href="{{ route('promociones.create') }}">Crear Promoción</a>
                    </div>
