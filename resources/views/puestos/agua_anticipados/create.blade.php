        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <form id="myform" method="POST" action="{{ route('puestos.aguaanticipados.store', $puesto) }}">
                            @csrf
                            ...
                            <div class="form-group row d-none">
                                ...
                                <div class="col-md-6">
                                    <input id="tipo_id" type="text" class="form-control @error('tipo_id') is-invalid @enderror" name="tipo_id" value="7" readonly autocomplete="tipo_id" autofocus>
