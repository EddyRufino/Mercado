        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <form id="myform" method="POST" action="{{ route('puestos.pagos.store', $puesto) }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="num_recibo" type="text" class="form-control @error('num_recibo') is-invalid @enderror" name="num_recibo" value="{{ $tazaInicio == $tazaFin ? 'Actualiza Talonario' : $tazaInicio + 1 }}" autocomplete="num_recibo" autofocus>
