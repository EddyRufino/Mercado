        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('puestos.pagoanticipados.store', $puesto) }}">
                            @csrf
...
{{-- <?php echo date("Y-m-d"); ?> --}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="num_recibo" type="text" class="form-control @error('num_recibo') is-invalid @enderror" name="num_recibo" value="{{ old('num_recibo') }}" autocomplete="num_recibo" autofocus>
                            ...
                            <div class="form-group row">
                                <label for="monto_sisa_anticipada" class="col-md-4 col-form-label text-md-right font-weight-normal text-dark">Monto Sisa</label>

                                <div class="col-md-6">
                                    <input id="monto_sisa_anticipada" type="text" class="form-control @error('monto_sisa_anticipada') is-invalid @enderror" name="monto_sisa_anticipada" value="{{ $puesto->sisa_diaria }}" required autocomplete="monto_sisa_anticipada" autofocus readonly>
...
{{--                             <div class="form-group row">
                                <label for="monto_agua_anticipada" class="col-md-4 col-form-label text-md-right font-weight-normal text-dark">Monto agua</label>

                                <div class="col-md-6">
                                    <input id="monto_agua_anticipada" type="text" class="form-control @error('monto_agua_anticipada') is-invalid @enderror" name="monto_agua_anticipada" value="{{ $puesto->monto_agua }}" required autocomplete="monto_agua_anticipada" autofocus readonly>
