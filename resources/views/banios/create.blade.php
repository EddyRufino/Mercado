                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('banios.store') }}">
                            ...
                            <div class="form-group row " id="ducha">
                                ...
                                <div class="col-md-6">
                                    <input id="monto_ducha" type="text" class="form-control @error('monto_ducha') is-invalid @enderror" name="monto_ducha" required autocomplete="monto_ducha" autofocus readonly>
