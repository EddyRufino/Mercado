                        ...
                        <tbody>
                            @forelse ($pagos as $pagosanticipado)
                                <tr>
                                    ...
                                    @if ($pagosanticipado->monto_sisa_anticipada)
                                        <td>S/. {{ $pagosanticipado->monto_sisa_anticipada }}</td>
                                    @else
                                        <td></td>
                                    @endif

                                    @if ($pagosanticipado->monto_agua_anticipada)
                                        <td>S/. {{ $pagosanticipado->monto_agua_anticipada }}</td>
                                    @else
                                        <td></td>
                                    @endif
