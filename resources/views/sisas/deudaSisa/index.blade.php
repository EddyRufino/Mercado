            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <h4 class="text-secondary text-center font-weight-bold mt-2 ">Listado De Deudas</h4>
                    ...
                    <div class="row justify-content-center mt-2">
                        <form action="{{ route('deuda.sisa.search') }}" class="form-inline">
                            @csrf
                          <div class="input-group input-group-md">
                            <select name="tipo_servicio" class="form-control">
                                <option value="">Elige</option>
                                <option value="2">Deuda Sisa</option>
                                <option value="5">Deuda Agua</option>
                            </select>
